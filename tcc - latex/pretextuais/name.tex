...
\begin{flushright}
\begin{tabular}{l}
     {\bfseries Orientador: Prof. \Orientador}  \\
     \\
     {\bfseries Coordenador: Prof. \Coordenador}
\end{tabular}
\end{flushright}
...
\HRule\\
Prof. \Orientador, \Universidade

\vspace*{\fill}

\HRule\\
Prof. \BancaA, \BancaAInst

\vspace*{\fill}

\HRule\\
Prof. \BancaB, \BancaBInst

%% Retirar o comentário das próximas 3 linhas caso tenha um quarto membro na banca
% \vspace*{\fill}
% \HRule\\
% Prof. \BancaC, \BancaCInst
}
\end{center}
%\end{titlepage}